...
const All = ({tasks, handleDelete, handleCompleted, handleEdit}) => {
  return (
    <div className='p-4 '>
       <div className='flex items-center gap-3 text-lg mb-4'>
        ...
        <TAskCard  allTasks={tasks} handleDelete={handleDelete} handleCompleted={handleCompleted} handleEdit={handleEdit} />
    </div>
  )
}
